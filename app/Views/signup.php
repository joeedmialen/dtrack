        ...
        <div class="card-body register-card-body">
            ...
            <form id="register-form" method="post" novalidate="novalidate">
                <div class="input-group mb-3 form-group">
                    <input id="firstname1" required name="firstname" type="text" class="form-control login-input" placeholder="Firstname">
                ...
                <div class="input-group mb-3 form-group">
                    <input name="lastname" type="text" class="form-control login-input" placeholder="Lastname">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-user"></span>
                        </div>
                ...
                <div class="input-group mb-3 form-group">
                    <input id="password" name="password" type="password" class="form-control login-input" placeholder="Password">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <div class="input-group mb-3 form-group">
                    <input name="repeatpassword" type="password" class="form-control login-input" placeholder="Retype password">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
        ...
        $(function() {
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    ...
                    var url = "<?= base_url('signup_submit'); ?>";
