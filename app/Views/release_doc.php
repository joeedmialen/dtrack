...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas  fa-paper-plane"></i> Release Document</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('') ?>">Home</a></li>
                    <li class="breadcrumb-item active">Release Document</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body  d-flex flex-row justify-content-center align-content-center ">
                <div class="row" style="max-width: 300px;">
                    <div class="col-12 text-center pt-4 pb-4 h5">
                        Track releasing of Document with:
                    </div>
                    <div class="col-12">
                        <a href="<?= base_url('release_doc_by_qrcode') ?>" class="info-box btn-app">
                    ...
                    <div class=" col-12">
                        <a href="<?= base_url('release_doc_by_tracking_code') ?>" class="info-box btn-app">
